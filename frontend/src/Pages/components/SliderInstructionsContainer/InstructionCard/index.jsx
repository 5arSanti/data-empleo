...
const InstructionCard = ({item={}, index=null}) => {
    return(
        <WrapperContainer2 flexDirection="column" justifyContent="center" alignItems="center" padding={30}>
            <WrapperContainer3 flexDirection="column" alignItems="center" justifyContent="center" padding={50}>
                ...
                <WrapperContainer2 gap={7} padding={0} flexDirection="column">
